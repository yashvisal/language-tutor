      ...
      <div className="sticky bottom-0 mt-8 bg-background/80 pt-3 pb-2 backdrop-blur-sm">
        ...
        <div className="relative">
          <textarea
            ...
            // 2026-09-09).
            className="[field-sizing:content] max-h-40 min-h-24 w-full resize-none [scrollbar-width:thin] rounded-lg border border-border/60 bg-background/60 py-2 pr-12 pl-3 text-sm leading-6 transition-colors outline-none placeholder:text-muted-foreground focus:border-border"
          />
          <Button
            type="button"
            size="icon-sm"
